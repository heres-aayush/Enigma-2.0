...
import { IconHome, IconFeather, IconUsers, IconLogin, IconUpload, IconFiretruck } from '@tabler/icons-react'
// import Pagebackground from '@/components/ui/pagecomponent'
...
export default function Home() {
  const navItems = [
    { title: 'Home', icon: <IconHome className="h-25 w-25" />, href: '#home' },
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bod relative min-h-screen"> 
      ...
      <div className="relative mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left z-[1] ">
        ...
        <a
          href="/faqs.html"
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 mb-1"
          target="_blank"
          rel="noopener noreferrer"
        >
          <h2 className="mb-3 text-2xl font-semibold">
